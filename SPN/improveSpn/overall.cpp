...
int Pbox[16]={0,4,8,12,1,5,9,13,2,6,10,14,3,7,11,15};      // P盒子
int  S_inverse[16][16]={0};
long long key[Nr+1]={0};

unsigned long long k1=0x0000000000000000;
unsigned long long k2=0x0000000000000000;
